...
ERLANG_MK_VERSION = 2019.07.01-11-g60c7028
ERLANG_MK_WITHOUT = 
...
clean-app:
	$(gen_verbose) if [ -e "ebin/$(PROJECT).appup" ]; then \
		rm -rf ebin/test ebin/*.app ebin/*.beam; \
	else \
		rm -rf ebin/; \
	fi
	$(gen_verbose) rm -rf $(PROJECT).d priv/mibs/ $(XRL_ERL_FILES) $(YRL_ERL_FILES) \
